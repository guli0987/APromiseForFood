...
/* 0 */
/*!***********************************************************!*\
  !*** D:/HBuilderX Projects/APromiseForFood-Alpha/main.js ***!
  \***********************************************************/
...
/* 5 */
/*!***********************************************************!*\
  !*** D:/HBuilderX Projects/APromiseForFood-Alpha/App.vue ***!
  \***********************************************************/
/*! no static exports found */
...
/* 6 */
/*!************************************************************************************!*\
  !*** D:/HBuilderX Projects/APromiseForFood-Alpha/App.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 7 */
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/HBuilderX Projects/APromiseForFood-Alpha/App.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 应用生命周期仅可在App.vue中监听，在其它页面监听无效。 */var _default =
{
  ...
  (0, _vuex.mapMutations)(['checkTokenAndLogin'])),
  (0, _vuex.mapActions)(['updateCachePosition'])), {}, {

    initStart: function initStart() {
      this.initLogin();
      this.initLocalCache();
    },
    //验证登录状态
    initLogin: function initLogin() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var uniIdToken, checkTokenOptions, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                uniIdToken = uni.getStorageSync('uni_id_token');if (!
                uniIdToken) {_context.next = 10;break;}
                //this.login(uni.getStorageSync('username'))
                /* token校验登录状态 */
                //是否
                checkTokenOptions = { needPermission: false, needUserInfo: true };_context.next = 5;return (
                  _this.$request('userCenter', 'checkToken', { uniIdToken: uniIdToken, checkTokenOptions: checkTokenOptions }));case 5:res = _context.sent;
                console.log("token校验结果：" + JSON.stringify(res));
                if (res.result.code === 0) {
                  _this.checkTokenAndLogin(res.result.userInfo);
                  uni.showToast({
                    title: '状态:在线' });

                }_context.next = 11;break;case 10:

                console.log("uniIdToken错误:" + uniIdToken);case 11:case "end":return _context.stop();}}}, _callee);}))();

    },
    initLocalCache: function initLocalCache() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var apffCachePosition;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                apffCachePosition = uni.getStorageSync('apff_cache_position');
                console.log("缓存测试结果:" + JSON.stringify(apffCachePosition));
                if (apffCachePosition) {
                  _this2.updateCachePosition(apffCachePosition);
...
/* 12 */
/*!********************************************************************************************!*\
  !*** D:/HBuilderX Projects/APromiseForFood-Alpha/App.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 13 */
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/HBuilderX Projects/APromiseForFood-Alpha/App.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
