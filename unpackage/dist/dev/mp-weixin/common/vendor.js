...
var _cache = _interopRequireDefault(__webpack_require__(/*! @/store/modules/cache */ 22));
var _cart = _interopRequireDefault(__webpack_require__(/*! @/store/modules/cart */ 23));
var _products = _interopRequireDefault(__webpack_require__(/*! @/store/modules/products */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _uCharts = _interopRequireDefault(__webpack_require__(/*! ../../js_sdk/u-charts/u-charts/u-charts.js */ 117));
var _checker = __webpack_require__(/*! @/common/js/checker.js */ 175);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
var _self;
...
var _cache = _interopRequireDefault(__webpack_require__(/*! ./cache */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
//云函数映射 默认apff-uni
var moduleMap = {
  user: 'apff-user',
  payment: 'apff-pay',
